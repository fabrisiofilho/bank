package br.com.hiven.bank.security.detail;
...
public class AuthUser implements UserDetails {
    ...
    private Collection<GrantedAuthority> getAuthoritiesUser(UserEntity user){
        ...
        user.getProfiles().forEach(profile ->
                profile.getProfilesRoles().forEach(profileRole ->
                        authory.add(new SimpleGrantedAuthority(profileRole.getRole().getName()))));
        return authory;
    }
